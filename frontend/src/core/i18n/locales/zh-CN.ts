...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用SolarSeptem，一个完全开源的超级智能体。SolarSeptem 几乎可以帮你做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 SolarSeptem 的潜力。通过自定义技能，SolarSeptem\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，SolarSeptem 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 SolarSeptem 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 SolarSeptem 官方网站",
    githubTooltip: "访问 SolarSeptem 的 Github 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 Github 上查看 SolarSeptem",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 SolarSeptem",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 SolarSeptem 中使用",
  },
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 SolarSeptem 的界面和行为。",
    sections: {
      appearance: "外观",
      memory: "记忆",
      models: "模型",
    ...
    memory: {
      title: "记忆",
      description:
        "SolarSeptem 会在后台不断从你的对话中自动学习。这些记忆能帮助 SolarSeptem 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    models: {
      title: "模型",
      description: "管理可用的 AI 模型，包括本地模型和远程模型。",
      localModels: "本地模型",
      remoteModels: "远程模型",
      ...
      search:"搜索",
      defaultModel: "默认模型",
      defaultModelDescription: "选择默认使用的 AI 模型。",
      selectModel: "选择模型",
      empty: "还没有配置任何模型。",
      loadError: "加载模型列表失败。",
    },
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 SolarSeptem 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "SolarSeptem 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
      requestPermission: "请求通知权限",
      deniedHint:
        "通知权限已被拒绝。可在浏览器的网站设置中重新开启，以接收完成提醒。",
      testButton: "发送测试通知",
      testTitle: "SolarSeptem",
      testBody: "这是一条测试通知。",
    ...
    mcp: {
      title: "MCP",
      description: "创建和管理 MCP (Model Context Protocol) 客户端，扩展智能体的能力。",
      serverEnabled: "服务器已启用",
      serverDisabled: "服务器已禁用",
      enabled: "已启用",
      disabled: "已禁用",
      loadError: "加载 MCP 配置失败",
      emptyTitle: "还没有 MCP 客户端",
      emptyDescription: "创建你的第一个 MCP 客户端，扩展智能体的能力。",
      newClient: "新建客户端",
      create:"创建",
      cancel:"取消",
      noDescription: "暂无描述",
      documentation: "文档",
      documentationDescription: "了解更多关于 MCP 的信息",
      documentationText:
        "Model Context Protocol (MCP) 是一个开放协议，它提供了一种标准化的方式来连接 AI 助手与外部数据源和工具。",
      learnMore: "了解更多",
    },
  },
};
