...
export function Hero({ className }: { className?: string }) {
    return (
        ...
        >
            ...
            <FlickeringGrid
                className="absolute inset-0 z-0 translate-y-8 mask-[url(/images/tiger.svg)] mask-size-[100vw] mask-center mask-no-repeat md:mask-size-[72vh]"
                squareSize={4}
                gridGap={4}
                color={"white"}
                maxOpacity={0.3}
            ...
            <div className="container-md relative z-10 mx-auto flex h-screen flex-col items-center justify-center">
                ...
                <p className="text-muted-foreground mt-8 scale-105 text-center text-2xl text-shadow-sm">
                    一个开源的SuperAgent工具，用于研究、编码和创建。
                    <br />
                    随着在沙盒、记忆、工具、技能和子代理的帮助下，它可以处理不同级别的任务，可能需要几分钟到几小时。
                </p>
                <Link href="/workspace">
