...
from solarseptem_deepresearch.app.gateway.deps import get_checkpointer, get_run_manager, get_store, get_stream_bridge
from solarseptem_deepresearch.runtime import (
    END_SENTINEL,
    HEARTBEAT_SENTINEL,
    ConflictError,
    DisconnectMode,
...
def resolve_agent_factory(assistant_id: str | None):
    ...
    """
    from solarseptem_deepresearch.agents.lead_agent.agent import make_lead_agent
...
async def _upsert_thread_in_store(store, thread_id: str, metadata: dict | None) -> None:
    ...
    from solarseptem_deepresearch.app.gateway.routers.threads import _store_upsert
...
async def _sync_thread_title_after_run(
    ...
    # Deferred import to avoid circular import with the threads router module.
    from solarseptem_deepresearch.app.gateway.routers.threads import _store_get, _store_put
