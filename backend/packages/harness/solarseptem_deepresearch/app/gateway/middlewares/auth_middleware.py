...
``solarseptem_deepresearch.runtime.user_context`` contextvar so that repository-layer
...
from solarseptem_deepresearch.app.gateway.auth.errors import AuthErrorCode, AuthErrorResponse
from solarseptem_deepresearch.app.gateway.auth.authz import _ALL_PERMISSIONS, AuthContext
from solarseptem_deepresearch.app.gateway.auth.internal_auth import INTERNAL_AUTH_HEADER_NAME, get_internal_user, is_valid_internal_auth_token
from solarseptem_deepresearch.runtime.user_context import reset_current_user, set_current_user
...
class AuthMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        from solarseptem_deepresearch.app.gateway.deps import get_current_user_from_request
