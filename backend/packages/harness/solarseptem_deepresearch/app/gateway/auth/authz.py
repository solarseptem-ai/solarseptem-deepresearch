...
async def _authenticate(request: Request) -> AuthContext:
    ...
    """
    from solarseptem_deepresearch.app.gateway.deps import get_optional_user_from_request
    ...
    def decorator(func: Callable[P, T]) -> Callable[P, T]:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if owner_check:
                ...
                from solarseptem_deepresearch.app.gateway.deps import get_thread_store
