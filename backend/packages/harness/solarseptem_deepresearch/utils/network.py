...
class PortAllocator:
    ...
    Usage:
        ...
        port = port_allocator.allocate(start_port=8080)
        try:
            # Use the port...
        finally:
    ...
    def allocate(self, start_port: int = 7520, max_range: int = 100) -> int:
    ...
    @contextmanager
    def allocate_context(self, start_port: int = 7520, max_range: int = 100):
...
def get_free_port(start_port: int = 7520, max_range: int = 100) -> int:
