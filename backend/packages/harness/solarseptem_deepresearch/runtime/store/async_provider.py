...
from solarseptem_deepresearch.runtime.store.provider import POSTGRES_CONN_REQUIRED, POSTGRES_STORE_INSTALL, SQLITE_STORE_INSTALL, ensure_sqlite_parent_dir, resolve_sqlite_conn_str
...
async def make_store() -> AsyncIterator[BaseStore]:
    ...
    :func:`solarseptem.agents.checkpointer.async_provider.make_checkpointer` so
