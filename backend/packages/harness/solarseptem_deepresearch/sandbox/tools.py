...
from solarseptem_deepresearch.agents.thread_state import ThreadDataState, ThreadState
from solarseptem_deepresearch.config.base import VIRTUAL_PATH_PREFIX
from solarseptem_deepresearch.sandbox.exceptions import (
    SandboxError,
    SandboxNotFoundError,
    SandboxRuntimeError,
)
from solarseptem_deepresearch.sandbox.base import Sandbox
from solarseptem_deepresearch.sandbox.provider import get_sandbox_provider
from solarseptem_deepresearch.sandbox.security import LOCAL_HOST_BASH_DISABLED_MESSAGE, is_host_bash_allowed
...
def _get_mcp_allowed_paths() -> list[str]:
    ...
    allowed_paths = []
    try:
        from solarseptem_deepresearch.config.extensions import get_extensions_config
