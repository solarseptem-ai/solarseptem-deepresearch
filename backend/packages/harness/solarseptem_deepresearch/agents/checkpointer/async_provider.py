...
Usage (e.g. FastAPI lifespan)::
    ...
    from solarseptem.agents.checkpointer.async_provider import make_checkpointer

    async with make_checkpointer() as checkpointer:
        app.state.checkpointer = checkpointer  # InMemorySaver if not configured

For sync usage see :mod:`solarseptem.agents.checkpointer.provider`.
"""
...
from solarseptem_deepresearch.agents.checkpointer.provider import (
    POSTGRES_CONN_REQUIRED,
    POSTGRES_INSTALL,
    SQLITE_INSTALL,
)
from solarseptem_deepresearch.config import get_app_config
from solarseptem_deepresearch.runtime.store._sqlite_utils import ensure_sqlite_parent_dir, resolve_sqlite_conn_str
