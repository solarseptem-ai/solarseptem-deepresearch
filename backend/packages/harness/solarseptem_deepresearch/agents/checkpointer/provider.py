...
Usage::
    ...
    from solarseptem.agents.checkpointer.provider import get_checkpointer, checkpointer_context
...
from solarseptem_deepresearch.config.agents import CheckpointerConfig
from solarseptem_deepresearch.runtime.store._sqlite_utils import resolve_sqlite_conn_str
...
def get_checkpointer() -> Checkpointer:
    ...
    from solarseptem_deepresearch.config.app_config import _app_config
    from solarseptem_deepresearch.config.agents import get_checkpointer_config
