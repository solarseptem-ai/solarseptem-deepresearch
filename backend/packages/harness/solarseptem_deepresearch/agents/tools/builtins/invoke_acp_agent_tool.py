...
def _get_work_dir(thread_id: str | None) -> str:
    ...
    """
    from solarseptem.config.paths import get_paths
...
def _build_mcp_servers() -> dict[str, dict[str, Any]]:
    ...
    from solarseptem.config.extensions import ExtensionsConfig
    from solarseptem.mcp.client import build_servers_config
